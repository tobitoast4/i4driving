 ...
 * 
 * <p>Java class for t_road_elevationProfile complex type.
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="elevation" type="{http://code.asam.net/simulation/standard/opendrive_schema}t_road_elevationProfile_elevation" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "t_road_elevationProfile", propOrder = {
    "elevation",
    "gAdditionalData"
})
@SuppressWarnings("all") public class TRoadElevationProfile
    extends OpenDriveElement
{

    protected List<TRoadElevationProfileElevation> elevation;
    @XmlElements({
     ...
     * {@link TRoadElevationProfileElevation }
     * 
     * 
     */
    public List<TRoadElevationProfileElevation> getElevation() {
        if (elevation == null) {
            elevation = new ArrayList<TRoadElevationProfileElevation>();
        }
