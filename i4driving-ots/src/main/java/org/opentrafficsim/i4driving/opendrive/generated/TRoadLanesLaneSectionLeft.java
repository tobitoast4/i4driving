 ...
 * 
 * <p>Java class for t_road_lanes_laneSection_left complex type.
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="lane" type="{http://code.asam.net/simulation/standard/opendrive_schema}t_road_lanes_laneSection_left_lane" maxOccurs="unbounded"/&gt;
...
@XmlType(name = "t_road_lanes_laneSection_left", propOrder = {
    "lane",
    "gAdditionalData"
})
@SuppressWarnings("all") public class TRoadLanesLaneSectionLeft
    extends OpenDriveElement
{

    @XmlElement(required = true)
    protected List<TRoadLanesLaneSectionLeftLane> lane;
    @XmlElements({
     ...
     * {@link TRoadLanesLaneSectionLeftLane }
     * 
     * 
     */
    public List<TRoadLanesLaneSectionLeftLane> getLane() {
        if (lane == null) {
            lane = new ArrayList<TRoadLanesLaneSectionLeftLane>();
        }
        return this.lane;
    }
