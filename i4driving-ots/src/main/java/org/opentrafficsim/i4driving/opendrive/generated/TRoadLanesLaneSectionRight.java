 ...
 * 
 * <p>Java class for t_road_lanes_laneSection_right complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="t_road_lanes_laneSection_right"&gt;
 *   &lt;complexContent&gt;
 *     &lt;extension base="{http://code.asam.net/simulation/standard/opendrive_schema}_OpenDriveElement"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="lane" type="{http://code.asam.net/simulation/standard/opendrive_schema}t_road_lanes_laneSection_right_lane" maxOccurs="unbounded"/&gt;
...
@XmlType(name = "t_road_lanes_laneSection_right", propOrder = {
    "lane",
    "gAdditionalData"
})
@SuppressWarnings("all") public class TRoadLanesLaneSectionRight
    extends OpenDriveElement
{

    @XmlElement(required = true)
    protected List<TRoadLanesLaneSectionRightLane> lane;
    @XmlElements({
     ...
     * {@link TRoadLanesLaneSectionRightLane }
     * 
     * 
     */
    public List<TRoadLanesLaneSectionRightLane> getLane() {
        if (lane == null) {
            lane = new ArrayList<TRoadLanesLaneSectionRightLane>();
        }
        return this.lane;
    }
