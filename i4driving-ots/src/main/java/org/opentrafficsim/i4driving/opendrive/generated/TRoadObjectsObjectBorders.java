 ...
 * 
 * <p>Java class for t_road_objects_object_borders complex type.
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="border" type="{http://code.asam.net/simulation/standard/opendrive_schema}t_road_objects_object_borders_border" maxOccurs="unbounded"/&gt;
...
@XmlType(name = "t_road_objects_object_borders", propOrder = {
    "border",
    "gAdditionalData"
})
@SuppressWarnings("all") public class TRoadObjectsObjectBorders
    extends OpenDriveElement
{

    @XmlElement(required = true)
    protected List<TRoadObjectsObjectBordersBorder> border;
    @XmlElements({
     ...
     * {@link TRoadObjectsObjectBordersBorder }
     * 
     * 
     */
    public List<TRoadObjectsObjectBordersBorder> getBorder() {
        if (border == null) {
            border = new ArrayList<TRoadObjectsObjectBordersBorder>();
        }
        return this.border;
    }
