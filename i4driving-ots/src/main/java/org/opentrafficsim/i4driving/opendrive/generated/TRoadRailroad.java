 ...
 * 
 * <p>Java class for t_road_railroad complex type.
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="switch" type="{http://code.asam.net/simulation/standard/opendrive_schema}t_road_railroad_switch" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "t_road_railroad", propOrder = {
    "_switch",
    "gAdditionalData"
})
@SuppressWarnings("all") public class TRoadRailroad
    extends OpenDriveElement
{

    @XmlElement(name = "switch")
    protected List<TRoadRailroadSwitch> _switch;
    @XmlElements({
     ...
     * {@link TRoadRailroadSwitch }
     * 
     * 
     */
    public List<TRoadRailroadSwitch> getSwitch() {
        if (_switch == null) {
            _switch = new ArrayList<TRoadRailroadSwitch>();
        }
        return this._switch;
    }
