...
public class CarFollowingTask extends AbstractTask
{
    ...
    public static final ParameterTypeDuration HEXP =
            new ParameterTypeDuration("h_exp", "Exponential decay of car-following task by headway.",
                    Duration.instantiateSI(3.83), NumericConstraint.POSITIVEZERO);
